...
// Paged history of analyzed games for one summoner, newest first. Live entries (match_id
// starting with 'LIVE_') are excluded — they're transient and not part of match history.
